...
public class Constant_Class {
    public static final String UpdateName = "Tablet_MoiTruong";
    public static final String Update_serverAPK = "Tablet_MoiTruong.apk";
    //public static final String Package_Name = "com.lelong.moitruong";
